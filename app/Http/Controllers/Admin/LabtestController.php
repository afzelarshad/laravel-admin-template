...
use App\Models\Labtest as Table;
use Exception;
use App\Http\Requests\LabtestRequests\UpdateLabtest as UpdateRequest;
use App\Http\Requests\LabtestRequests\AddLabtest as AddRequest;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Crypt;

class LabtestController extends Controller {
  protected $handle_name = "labtest";
  protected $handle_name_plural = "labtests";
  ...
  public function store(AddRequest $request) {
    try {
      $data = ['test_name' => $request->test_name, 'price' => $request->price, ];
